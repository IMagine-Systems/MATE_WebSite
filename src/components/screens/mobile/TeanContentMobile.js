...
export default function TeamContentMobile({team}) {
    if (team === "PO") {
        return (
            <div style={{display: 'flex', flexDirection:'column', alignItems: 'center', marginBottom: 95}}>
                <div style={{width: 320, height: 150, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', marginTop: 30, marginBottom: 30, position: 'relative'}}>
                    <div style={{paddingLeft: 10, paddingTop: 20}}>
                        <span style={{fontSize: 10}}>다음과 같은 활동을 합니다</span>
                    </div>
                ...
                <div style={{width: 320, height: 150, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', marginTop: 30, marginBottom: 30, position: 'relative'}}>
                    <div style={{paddingLeft: 10, paddingTop: 20}}>
                        <span style={{fontSize: 10}}>이런 기획자를 찾습니다</span>
                    </div>
                    <div style={{position: "absolute", left: "40%", top: 20}}>
                        <span style={{fontSize: 10}}>
                ...
                <div style={{width: 320, height: 150, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', marginTop: 30, marginBottom: 30, position: 'relative'}}>
                    <div style={{paddingLeft: 10, paddingTop: 20}}>
                        <span style={{fontSize: 10}}>이런 경험이 있으면 더 좋습니다</span>
                    </div>
        ...
        return (
            <div style={{display: 'flex', flexDirection:'column', alignItems: 'center', marginBottom: 95}}>
                <div style={{width: 320, height: 150, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', marginTop: 30, marginBottom: 30, position: 'relative'}}>
                    ...
                    <div style={{position: "absolute", left: "40%", top: 20}}>
                        <span style={{fontSize: 10}} style={{fontSize: 10}}>                                                        
