...
export default function TeanContentMobile({team}) {
    if (team === "PO") {
        return (
            <div style={{width: "100%", display: 'flex', flexDirection:'column', alignItems: 'center', marginBottom: 95}}>
                <div style={{ width: 255, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', flexDirection: 'column', marginTop: 30, marginBottom: 30}}>
                    <div style={{ marginTop: 35, marginBottom:23, fontSize: "15px", fontWeight: 600, display: 'flex', justifyContent: 'center'}}>
                ...
                <div style={{ width: 250, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', flexDirection: 'column', marginTop: 30, marginBottom: 30}}>
                    <div style={{display:'flex', justifyContent:'center', marginTop: 35, marginBottom:23, fontSize: "15px", fontWeight: 600}}>
                        <span>합류하면 함께 할 업무에요</span>
                    </div>
                    <div style={{marginLeft: 35, marginBottom: 35, marginRight: 35}}>
                        <span>
                            <li>좋은 문제 정의와 유효한 가설을 수립하고, 실험을 통해 도출된 Data Insight를 기반으로 가설을 검증하며, 끊임없는 Iteration을 통해 PMF를 찾아 제품을 고도화해요.</li>
                            <br></br>
                ...
                <div style={{ width: 250, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', flexDirection: 'column', marginTop: 30, marginBottom: 30}}>
                    ...
                    <div style={{marginLeft: 35, marginBottom: 35, marginRight: 35}}>
                        <span>
                            ...
                            <br></br>
                            <li>협업툴(git, notion 등)을 이용해 혼자 개발이 아닌 팀원들과 함께 개발을 하고 문서와 개인 기술 블로그를 작성하고 싶은 분이면 가능해요.</li>
                        </span>
                    </div>
                </div>
            </div>
        ...
        return (
            <div style={{width: "100%", display: 'flex', flexDirection:'column', alignItems: 'center', marginBottom: 95}}>
                <div style={{ width: 250, borderRadius:25 ,backgroundColor:"#f4f7fa", display: 'flex', flexDirection: 'column', marginTop: 30, marginBottom: 30}}>
                    ...
                    <div style={{marginLeft:35, justifyContent:'center', marginBottom: 35, marginRight: 35}}>
                        <span>
                            <li>Cell에서 정한 새로운 아이템 혹은 프로젝트를 진행하며 자신의 분야에 맞는 웹 서비스 혹은앱 서비스를 개발해요.</li>
                            <br></br>
                            <li>당장은 완벽한 서비스보다 빠른 MVP 개발에 집중을 해요.</li>
